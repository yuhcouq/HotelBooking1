					...
					<div class="sparkline13-graph">
						<div class="row">
							<h3 style="margin-left: 20px;">
								...
								<span><strong>Thêm mới khách hàng</strong></span>
							</h3>
						</div>
						<div class="row" style="margin: 50px 20px;">
							<form action="${pageContext.request.contextPath }/admin/booking/customer-add"
								...
								<div class="form-group-inner">
									<label>Thành phố <span style="color: red;">*</span></label> <input
										...
										placeholder="Vui lòng nhập ngày sinh"
										style="border-radius: 5px;" value="${user.city}" required />
								</div>
								<div class="form-group-inner">
