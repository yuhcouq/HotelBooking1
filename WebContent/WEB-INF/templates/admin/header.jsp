		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="logo-pro">
				<a href="index.html"><img class="main-logo"
					src="${defines.urlAdmin}/img/logo/logo.png" alt="" /></a>
			</div>
		</div>
	</div>
</div>
							...
							<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
								<div class="header-right-info">
									<ul class="nav navbar-nav mai-top-nav header-right-menu">
												...
												<ul class="message-menu">
													<li><a href="#">
															<div class="message-img">
																<img src="${defines.urlAdmin}/img/contact/1.jpg" alt="">
															</div>
													...
													<li><a href="#">
															<div class="message-img">
																<img src="${defines.urlAdmin}/img/contact/4.jpg" alt="">
															</div>
															<div class="message-content">
																<span class="message-date">16 Sept</span>
																<h2>Sulaiman din</h2>
													...
													<li><a href="#">
															<div class="message-img">
																<img src="${defines.urlAdmin}/img/contact/3.jpg" alt="">
															</div>
															<div class="message-content">
																<span class="message-date">16 Sept</span>
																<h2>Victor Jara</h2>
													...
													<li><a href="#">
															<div class="message-img">
																<img src="${defines.urlAdmin}/img/contact/2.jpg" alt="">
															</div>
															<div class="message-content">
																<span class="message-date">16 Sept</span>
																<h2>Victor Jara</h2>
										...
										<li class="nav-item"><a href="#" data-toggle="dropdown"
											role="button" aria-expanded="false"
											class="nav-link dropdown-toggle"> <c:choose>
													<c:when test="${not empty userAdmin}">
														<img
															src="${pageContext.request.contextPath }/uploads/${userAdmin.avatar}"
															alt="" />
													</c:when>
													<c:otherwise>
														<img
												...
												</c:choose> <span class="admin-name">${userAdmin.lastname}
													${userAdmin.firstname}</span> <i
												class="fa fa-angle-down edu-icon edu-down-arrow"></i></a>
											<ul role="menu"
												...
												<c:if test="${userAdmin.role_id == 1}">
													<li><a href="${pageContext.request.contextPath}/admin/movedata"><span
															class="edu-icon edu-settings author-log-ic"></span>Move
															Data</a></li>
												</c:if>
												<li><a
													href="${pageContext.request.contextPath}/admin/logout"><span
																...
																<ul class="notes-menu-list">
																	<li><a href="#">
																			<div class="notes-list-flow">
																				<div class="notes-img">
																					<img src="${defines.urlAdmin}/img/contact/4.jpg"
																						alt="" />
																				</div>
																	...
																	<li><a href="#">
																			<div class="notes-list-flow">
																				<div class="notes-img">
																					<img src="${defines.urlAdmin}/img/contact/1.jpg"
																						alt="" />
																				</div>
																				<div class="notes-content">
																					<p>The point of using Lorem Ipsum is that it
																	...
																	<li><a href="#">
																			<div class="notes-list-flow">
																				<div class="notes-img">
																					<img src="${defines.urlAdmin}/img/contact/2.jpg"
																						alt="" />
																				</div>
																				<div class="notes-content">
																					<p>The point of using Lorem Ipsum is that it
																	...
																	<li><a href="#">
																			<div class="notes-list-flow">
																				<div class="notes-img">
																					<img src="${defines.urlAdmin}/img/contact/3.jpg"
																						alt="" />
																				</div>
																				<div class="notes-content">
																					<p>The point of using Lorem Ipsum is that it
								...
								<li><a data-toggle="collapse" data-target="#formsmob"
									...
									<ul id="formsmob" class="collapse dropdown-header-top">
										<li><a href="basic-form-element.html">Basic Form
												Elements</a></li>
										<li><a href="advance-form-element.html">Advanced Form
												Elements</a></li>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="breadcome-list">
						<div class="row">
							<h3 style="text-align: center;">${userAdmin.hotel_name}</h3>
						</div>
					</div>
				</div>
			</div>
